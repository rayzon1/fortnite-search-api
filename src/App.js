...
import { searchProvider, playerProvider, userProvider } from './Components/Context/store';
      ...
      <Switch>
          ...
          > */}
            <div className="App">
              <Header />
              <HomeJumbotron />
              <TabLinks userProvider={userProvider} />
              <Route
                exact
                path="/"
                render={() => (newsResults.length === 0 ? null : <Home newsResults={userProvider.newsResults} />)}
              />
              <Route
                exact
                path="/upcoming"
                render={() => (results.length === 0 ? null : <Upcoming userProvider={userProvider} />)}
              />
                ...
                <Route
                  ...
                  path="/weaponsearch"
                  render={() =>
                    weaponResults.length === 0 ? null : <WeaponSearch searchProvider={searchProvider} userProvider={userProvider}/>
                  }
                />
              ...
              >
                <Route
                  exact
                  path="/playersearch"
                  render={() => <PlayerSearch searchProvider={searchProvider}/>}
                />
              </PlayerSearchProvider>
            </div>
          {/* </UserProvider> */}
